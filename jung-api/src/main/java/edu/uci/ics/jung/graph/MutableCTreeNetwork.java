...
public interface MutableCTreeNetwork<N, E> extends MutableNetwork<N, E>, CTreeNetwork<N, E> {
	 ...
	 * {@inheritDoc}
	 * 
	 * <p>Removes all nodes from the subtree rooted at the source of {@code edge},
