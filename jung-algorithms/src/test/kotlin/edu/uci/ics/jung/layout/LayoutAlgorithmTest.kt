...
class LayoutAlgorithmTest {
  ...
  private lateinit var layoutModel: LoadingCacheLayoutModel<String>
  ...
  fun testLayoutAlgorithms() {
    ...
    //    testLayoutAlgorithm(ISOMLayoutAlgorithm())
  ...
  private fun testUniqueLocations() {
    val locations = Sets.newHashSet<Point>()
    ...
    Assert.assertEquals(nodes.size.toLong(), locations.size.toLong())
  }
  ...
  companion object {
    private val log = LoggerFactory.getLogger(LayoutAlgorithmTest::class.java)
  }
}
