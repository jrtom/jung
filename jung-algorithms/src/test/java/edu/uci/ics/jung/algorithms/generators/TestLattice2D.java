...
public class TestLattice2D extends TestCase {
  ...
  protected void checkEdgeCount(
      Lattice2DGenerator<String, Number> generator, Graph<String, Number> graph) {
