...
/**
 * An edge weight function that assigns weights as uniform transition probabilities. For undirected
 * edges, returns 1/degree(v) (where 'v' is the vertex in the VEPair. For directed edges, returns
 * 1/outdegree(source(e)) (where 'e' is the edge in the VEPair). Throws an <code>
 * IllegalArgumentException</code> if the input edge is neither EdgeType.UNDIRECTED nor
 * EdgeType.DIRECTED.
 */
