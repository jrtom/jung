...
/**
 * Abstract data container for ranking objects. Stores common data relevant to both node and edge
 * rankings, namely, the original position of the instance in the list and the actual ranking score.
 *
 * @author Scott White
 */
