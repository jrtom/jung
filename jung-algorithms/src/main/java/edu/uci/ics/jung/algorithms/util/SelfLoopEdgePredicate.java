...
/**
 * A <code>Predicate</code> that returns <code>true</code> if the input edge's endpoints in the
 * input graph are identical. (Thus, an edge which connects its sole incident vertex to itself).
 *
