...
public class DijkstraDistance<V, E> implements Distance<V> {
  ...
  public DijkstraDistance(
      Hypergraph<V, E> g, Function<? super E, ? extends Number> nev, boolean cached) {
    this.g = g;
    this.nev = nev;
  ...
  /**
   * Returns the set of edges incident to <code>v</code> that should be tested. By default, this is
   * the set of outgoing edges for instances of <code>Graph</code>, the set of incident edges for
   * instances of <code>Hypergraph</code>, and is otherwise undefined.
   *
