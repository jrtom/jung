...
public class BarabasiAlbertGenerator<N, E> {
    ...
    public BarabasiAlbertGenerator(NetworkBuilder<Object, Object> graphBuilder,
    ...
    public BarabasiAlbertGenerator(NetworkBuilder<Object, Object> graphBuilder,
    		...
    		Supplier<E> edgeFactory,
    		int init_vertices, int numEdgesToAttach) {
        this(graphBuilder, vertexFactory, edgeFactory, init_vertices, numEdgesToAttach,
