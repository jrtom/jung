...
/**
 * This class provides basic infrastructure for relative authority algorithms that compute the
 * importance of nodes relative to one or more root nodes. The services provided are:
 *
 * <ul>
 *   <li>The set of root nodes (priors) is stored and maintained
 *   <li>Getters and setters for the prior rank score are provided
 * </ul>
 *
 * @author Scott White
 */
