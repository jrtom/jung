...
/**
 * StaticLayout places the vertices in the locations specified by its initializer, and has no other
 * behavior. Vertex locations can be placed in a {@code Map<V,Point2D>} and then supplied to this
 * layout as follows: {@code Function<V,Point2D> vertexLocations = Functions.forMap(map);}
 *
