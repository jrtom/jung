...
public class RadiusGraphElementAccessor<V, E> implements GraphElementAccessor<V, E> {
   ...
   * click. Override this method to provide a more efficient implementation.
   *
   ...
   * &lt; {@code maxDistance}. Iterates through all visible vertices and checks their distance from
