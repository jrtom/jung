 ...
 *
 * PageRank is an eigenvector-based algorithm. The score for a given node may be thought of as
 ...
 *
 * The original algorithm assumed that, for a given node, the probability of following any
 ...
 *
 * If a node has no outgoing edges, then the probability of taking a random jump from that node
 ...
 */
open class PageRank<N : Any, E : Any> : PageRankWithPriors<N, E> {
   ...
   */
  constructor(graph: Network<N, E>, edge_weight: Function<E, out Number>, alpha: Double)
   ...
   * @param alpha the probability of taking a random jump to an arbitrary node
   */
  constructor(graph: Network<N, E>, alpha: Double)
