 ...
 * by a {@code Function<? super V, Integer>}) and vertex aspect ratio function (specified by a
 * {@code Function<? super V, Float>}) implementations: the width of the bounding box of the shape
...
public class VertexShapeFactory<V> {
  ...
  /**
   * Creates a <code>VertexShapeFactory</code> with a constant size of 10 and a constant aspect
   * ratio of 1.
   */
