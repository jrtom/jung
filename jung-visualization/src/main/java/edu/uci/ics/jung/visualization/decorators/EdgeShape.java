...
public class EdgeShape<E> {
  ...
  public static class BentLine<N, E> extends ParallelEdgeShapeTransformer<N, E> {
  ...
  public static class QuadCurve<N, E> extends ParallelEdgeShapeTransformer<N, E> {
    @Override
   ...
   */
  public static class CubicCurve<N, E> extends ParallelEdgeShapeTransformer<N, E> {
    public void setEdgeIndexFunction(EdgeIndexFunction<N, E> edgeIndexFunction) {
      this.edgeIndexFunction = edgeIndexFunction;
      loop.setEdgeIndexFunction(edgeIndexFunction);
    }
   ...
   */
  public static class Loop<N, E> extends ParallelEdgeShapeTransformer<N, E> {
    public Shape apply(Context<Network<N, E>, E> context) {
      Network graph = context.graph;
      E e = context.element;
   ...
   * @author Joshua O'Madadhain
   */
  public static class Wedge<N, E> extends ParallelEdgeShapeTransformer<N, E> {
   ...
   * instances will not overlap.
   */
  public static class Box<N, E> extends ParallelEdgeShapeTransformer<N, E> {
    public Shape apply(Context<Network<N, E>, E> context) {
      Network graph = context.graph;
      E e = context.element;
  ...
  /** An edge shape that renders as a bent-line between the vertex endpoints. */
  public static class Orthogonal<N, E> extends ParallelEdgeShapeTransformer<N, E> {
    Box box;
