...
interface EdgeLabelRenderer {
     ...
     *     up to the renderer implementation. For example, if `value` is the string "true", it
     ...
     */
    fun <E> getEdgeLabelRendererComponent(
    ...
    fun isRotateEdgeLabels(): Boolean

    fun setRotateEdgeLabels(state: Boolean)
}
