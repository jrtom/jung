 ...
 * @author Tom Nelson
 */
open class PredicatedParallelEdgeIndexFunction<N, E>(
    var predicate: Predicate<E>
) : ParallelEdgeIndexFunction<N, E>() {
    ...
    override fun getIndex(context: Context<Network<N, E>, E>): Int =
        if (predicate.test(context.element)) 0 else super.getIndex(context)
}
